...
<head>
    ...
    <title>Delete Server - MicroNodes</title>
...
<div class="bg-light dashboard">
    ...
    <p class="text-center">Delete a Server</p>
    <center>
    ...
    if ($_GET['err']) {
      ...
      echo "<div class='alert alert-success w-25'>Server Deleted Successfully!</div>";
    }
    ?>
...
if (sizeof(json_decode($response)->attributes->relationships->servers->data) == 0) {
  header("Location: ../");
	...
	?> 
        ...
        <button class="btn btn-info">Delete Server</button><br>
        <script src="//servedby.eleavers.com/ads/ads.php?t=MjMxOTY7MTQyNDg7aG9yaXpvbnRhbC5iYW5uZXI=&index=1"></script>
